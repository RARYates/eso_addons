...
function HarvensImprovedSkillsWindow.Initialize(eventCode, addonName)
	...
	local checkboxTotal = WINDOW_MANAGER:CreateControlFromVirtual(SKILLS_WINDOW.container:GetName().."HarvensShowTotal", SKILLS_WINDOW.container, "HarvensImprovedSkillsWindowShowDetails")
