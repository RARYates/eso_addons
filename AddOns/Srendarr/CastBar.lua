...
local function OnActionSlotAbilityUsed(evt, slot)
	...
	if (auraLookupPlayer[1046327] and data.abilityName == crystalFragments and not auraLookupPlayer[1046327].isFading) then return end -- no cast bar if ability is frags and the proc is active (instant)
