...
settext("Short prefix for chat messages", "Kurzes Präfix für Nachrichten")
settext("When activated, all chat messages will be prefixed with [AGS] instead of [AwesomeGuildStore].", "Wenn aktiviert, wird bei alle Chat Nachrichten [AGS] anstelle von [AwesomeGuildStore] vorangestellt.")
