...
function WritCreater.writCompleteStrings() -- Vital for translation
	...
	["Rolis Hlaalu"] = "劳利仕", -- This is the same in most languages but ofc chinese and japanese
	}
	return strings
end
...
WritCreater.optionStrings["container delay"]							= "延迟容器拾取"
WritCreater.optionStrings["container delay tooltip"]					= "当你从获得日常奖励容器后延迟自动拾取"
